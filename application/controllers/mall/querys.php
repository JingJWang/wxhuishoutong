...
class Querys extends CI_Controller {
     ...
     */
    function luxurys(){
       $this->load->model('mall/querys_model');
    ...
    function orderSeach(){
        ...
        switch ($lists['0']['status']) {
            case '0':
                $lists['0']['status_c']='无效';
            case '1':
                $lists['0']['status_c']='检验通过 待上架';
                break;
            case '2':
                $lists['0']['status_c']='已售出 待付款';
                break;
            case '3':
                $lists['0']['status_c']='已付款';
                break;
            case '4':
                $lists['0']['status_c']='上架成功';
                break;
            case '5':
                $lists['0']['status_c']='寄售期到 已下架';
                break;
            case '6':
                $lists['0']['status_c']='退回';
                break;
