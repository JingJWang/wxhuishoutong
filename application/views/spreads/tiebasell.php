...
<a class="advert" href="javascript:;">
    <img src="/static/shop/images/advn.jpg"/>
</a>
<div class="mostly" style="margin-bottom: 0px;">
    <div class="deal">
        <span>已经成交了</span>
    ...
    <div class="handle">
        <a class="bought phone fl" href="http://wx.recytl.com/index.php/nonstandard/submitorder/ViewBrand?id=5">卖手机</a>
        <a class="bought fr" href="http://platform.91jst.com/Consign/Client/Web/category.html?cid=2&ccid=6&bid=1<?php if (isset($rand)) { echo '&rand='.$rand; } ?><?php echo '&from='.$from ?>">卖奢侈品</a>
    </div>
</div>
<div class="reveal">
    <img src="/static/shop/images/advs.jpg"/>
</div>
<div class="reveal">
    <img src="/static/shop/images/flow.jpg"/>
</div>
...
<a class="recover" data-index="1" href="/index.php/shop/flowgood/spreadbuy/<?php echo $from; ?>"></a>
<div class="full-bottom"></div>
<div class="operate">
    <div class="master">
        <a class="bought phone fl" href="http://wx.recytl.com/view/shop/list.html?type=15">卖手机</a>
        <a class="bought fr" href="http://platform.91jst.com/Consign/Client/Web/category.html?cid=2&ccid=6&bid=1<?php if (isset($rand)) { echo '&rand='.$rand; } ?><?php echo '&from='.$from ?>">卖奢侈品</a>
    </div>
</div>
