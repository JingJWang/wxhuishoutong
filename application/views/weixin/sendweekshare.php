...
<link   type="text/css" rel="stylesheet" href="<?php echo $this->config->item('CSSPATH'); ?>main2.css"/>
...
<body>
<div class="parent">
        <img class="red-bags" src="/static/weixin/public/img/page1_01.jpg"/>
        <div class="onsent">
        	<img src="/static/weixin/public/img/pic_btn_03.png"/>
        </div>
        <div class="footer-me">
        	<img src="<?php echo $userinfo['0']['wx_img']; ?>"/>
            <span>&nbsp&nbsp我抢到的现金券总额<strong>&nbsp<?php echo $picnum?></strong>元</span>
        </div>
     </div>
</body>
</html>
