...
if (selectP=='01')
{ a=1;tempoption=new Option('北京市','01',false,true); }
else
{ tempoption=new Option('直辖市','直辖市'); }
eval('document.'+VeryHuo+'.'+preP+'.options[1]=tempoption;');
cityareacode[0]=new Array('0101','0102','0103','0104');
cityareaname[0]=new Array('北京市','上海市','重庆市','天津市');


if (selectP=='02')
{ a=2;tempoption=new Option('新疆','02',false,true); }
else
...
if (selectP=='03')
{ a=3;tempoption=new Option('宁夏','03',false,true); }
else
{ tempoption=new Option('宁夏','宁夏'); }
eval('document.'+VeryHuo+'.'+preP+'.options[3]=tempoption;');
cityareacode[2]=new Array('0301','0302','0303','0304');
cityareaname[2]=new Array('银川','石嘴山','银南','固原');



if (selectP=='04')
{ a=4;tempoption=new Option('青海','04',false,true); }
else
{ tempoption=new Option('青海','青海'); }
eval('document.'+VeryHuo+'.'+preP+'.options[4]=tempoption;');
cityareacode[3]=new Array('0401','0402','0403','0404','0405','0406','0407','0408');
cityareaname[3]=new Array('西宁','海东',' 海北 ','黄南','海南','果洛','玉树','海西');



if (selectP=='05')
{ a=5;tempoption=new Option('甘肃','05',false,true); }
else
...
cityareaname[4]=new Array('兰州','金昌','白银','天水','嘉峪关','定西','平凉','庆阳','陇南','武威','张掖','酒泉','甘南 ','临夏');
...
cityareaname[5]=new Array('广州','珠海','深圳','佛山','东莞','清远','肇庆','阳江','湛江','韶关','惠州','河源','汕尾','汕头','梅州','中山');
...
if (selectP=='29')
{ a=29;tempoption=new Option('其他','29',false,true); }
else
{ tempoption=new Option('其他','其他'); }
eval('document.'+VeryHuo+'.'+preP+'.options[29]=tempoption;');
cityareacode[28]=new Array('2901','2902','2903');
cityareaname[28]=new Array('香港','澳门','台湾');
...
{
tempoption=new Option(cityareaname[cityid-1][i],cityareaname[cityid-1][i]);//此处把cityareaname改为cityareacode，就可以得到地区数字
eval('document.'+VeryHuo+'.'+preC+'.options[i+1]=tempoption;');
}
}
}