...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ['cleardoc',"paragraph","fontfamily","fontsize","inserttable",'background',"uploadword",'simpleupload',"insertimage",'insertvideo',"horizontal","|","undo","redo","|","more"],
        ["source",'remotecontent', 'spechars','emotion','link','superscript', 'subscript','insertorderedlist', 'insertunorderedlist','directionalityltr', 'directionalityrtl','searchreplace', 'help','message']
        ]
